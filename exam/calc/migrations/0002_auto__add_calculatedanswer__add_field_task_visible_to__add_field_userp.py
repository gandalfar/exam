...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CalculatedAnswer'
        db.create_table('calc_calculatedanswer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('var1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='calculated_var1', to=orm['calc.Dataset'])),
            ('var2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='calculated_var2', to=orm['calc.Dataset'])),
        ))
        db.send_create_signal('calc', ['CalculatedAnswer'])

        # Adding field 'Task.visible_to'
        db.add_column('calc_task', 'visible_to',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'UserProfile.is_special'
        db.add_column('calc_userprofile', 'is_special',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CalculatedAnswer'
        db.delete_table('calc_calculatedanswer')

        # Deleting field 'Task.visible_to'
        db.delete_column('calc_task', 'visible_to')

        # Deleting field 'UserProfile.is_special'
        db.delete_column('calc_userprofile', 'is_special')
