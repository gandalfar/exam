...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CalculatedAnswer.value'
        db.alter_column('calc_calculatedanswer', 'value', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'CalculatedAnswer.value'
        db.alter_column('calc_calculatedanswer', 'value', self.gf('django.db.models.fields.IntegerField')())
