...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CalculatedAnswer.task'
        db.add_column('calc_calculatedanswer', 'task',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['calc.Task']),
                      keep_default=False)
