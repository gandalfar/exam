...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CalculatedAnswer.value'
        db.add_column('calc_calculatedanswer', 'value',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CalculatedAnswer.value'
        db.delete_column('calc_calculatedanswer', 'value')
